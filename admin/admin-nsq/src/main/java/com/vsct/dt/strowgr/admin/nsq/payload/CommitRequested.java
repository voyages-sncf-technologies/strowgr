...
public class CommitRequested {
    ...
    public CommitRequested(String correlationId, String application, String platform, String confBase64, String syslogConfBase64, String bind) {
        this(new Header(correlationId, application, platform), new Conf(confBase64, syslogConfBase64, bind));
    }
