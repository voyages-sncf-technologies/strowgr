...
public class NSQDispatcher {
     ...
     */
    public void sendCommitRequested(String correlationId, String haproxyName, String application, String platform, String haproxyConf, String syslogConf, String bind) throws JsonProcessingException, NSQException, TimeoutException, UnsupportedEncodingException {
        ...
        CommitRequested payload = new CommitRequested(correlationId, application, platform, confBase64, syslogConfBase64, bind);
